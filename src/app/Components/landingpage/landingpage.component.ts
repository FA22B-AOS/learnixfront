...
import {BuyticketComponent} from "./Content/buyticket/buyticket.component";
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, HttpClientModule, RouterLink, HeroComponent, HeaderComponent, AboutComponent, SpeakersComponent, FooterComponent, ContactComponent, BuyticketComponent, SubscribeComponent, FaqComponent, SupportersComponent, GalleryComponent, HotelsComponent, VenueComponent, ScheduleComponent],
